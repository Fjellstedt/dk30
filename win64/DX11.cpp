...
namespace Cryptic
{
	...
	B32 DX11::Initialize(HWND hwnd, PlatformLayer *platLayer)
	{
		...
		m_tmpShader.Initialize(m_device, hwnd, L"shaders/hlsl/color_vs.hlsl", L"shaders/hlsl/color_ps.hlsl");
		return true;
	}
	...
	void DX11::Render(RenderState *state)
	{
		...
		m_tmpShader.Render(m_deviceContext, 3, m_worldMatrix, view, m_projectionMatrix);
		// Swap Back Buffer
